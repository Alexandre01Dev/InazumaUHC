...
public class Kevin extends Role {
    public Kevin() {
        ...
        public void a(String[] args, Player player) {
                ...
                target.addPotionEffect(new PotionEffect(PotionEffectType.WEAKNESS, 300, 1,false,false), true);
                target.addPotionEffect(new PotionEffect(PotionEffectType.SLOW, 100, 1,false,false), true);
